...
Make sure that the workflow using this action has access to the Chart registry by setting up appropriate secrets depending on the type of registry you'd like to publish to (see `inputs` below).
